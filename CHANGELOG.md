...
* **camera:** fix initialization AVCaptureDeviceFormat ([fcdc782](https://github.com/flyve-mdm/flyve-mdm-ios-inventory/commit/fcdc782))
* **network:** get network type from reachability class ([01aad47](https://github.com/flyve-mdm/flyve-mdm-ios-inventory/commit/01aad47))
